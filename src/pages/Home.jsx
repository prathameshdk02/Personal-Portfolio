  ...
  const handleDTSectionChange = useDebounce((e) => {
    ...
    setHomeCtx((prevHomeCtx) => {
      if (prevHomeCtx.currentSection < SECTION_COUNT) {
        return {
          ...prevHomeCtx,
          currentSection: prevHomeCtx.currentSection + 1,
          doSmoothScroll: true,
        };
      }
    ...
    return (
      <>
          ...
          <article className="w-full flex flex-col items-center gap-20 sm:gap-4 sm:flex-row pt-8 sm:pt-0">
            ...
            >
              <motion.div
                ...
                className="absolute w-[120%] h-[120%] left-1/2 top-1/2 border-8 border-l-transparent border-r-transparent border-primaryhead rounded-full"
              ></motion.div>
              <img
          ...
          <motion.section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            >
              ...
              <p className="text-secondarytext">
                ...
                <br /> Currently exploring the web domain & the wonders it can
                bring about.
        ...
        >
          ...
          <Timeline>
            <TimeElement>
              ...
              <h2 className="text-xl text-primaryhead font-semibold">
                Jr. Software Developer Intern
              </h2>
              <h3 className="text-sm text-secondarytext font-medium">
                Sciative Solutions
              </h3>
              ...
              <ul className="text-primarytext text-base list-disc ps-5">
                <li>
                  Implemented a new web application for automating invoice
                  generation at Sciative.
                </li>
                <li>
                  Gained hands on experience working with Django & Python
                  libraries like Pandas, Numpy & Reportlab.
                </li>
                <li>
                  Collaborated with the product managers to understand their
                  requirements and tailored the application according to them.
                </li>
              </ul>
            ...
            <TimeElement>
              ...
              <ul className="text-primarytext text-base list-disc ps-5">
                <li>
                  Developed machine learning models for Cab Fare Prediction &
                  H1N1 Virus Awareness Prediction.
                </li>
                <li>
                  Learned different aspects of Machine Learning & laid basic
                  foundation in it.
                </li>
              </ul>
              <div className="!mt-3">
        ...
        <section
          onDoubleClick={handleDTSectionChange}
          id="home-section-4"
          className="home-4 min-h-svh flex flex-col pt-12 gap-10 text-slate-100"
        >
          <motion.h2
            initial={{ opacity: 0, y: -20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          <article className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
            {SKILLS.map((skill) => (
              <Card className="items-center">
                <img
                  className={`size-12 sm:size-16 ${skill.invert ? "invert" : ""}`}
                  src={skill.imgSrc}
                  alt={skill.imgAlt}
                />
                <h5 className="font-bold">{skill.head}</h5>
                <p className="text-secondarytext">{skill.subHead}</p>
              </Card>
            ))}
          </article>
        </section>
