...
import { cardWhileHover, fadeIn, pulsate, verticalBob } from '../styles/motion/animations';
    ...
    <>
      ...
      <section
        ...
        <section className="grid grid-cols-1 place-items-center md:grid-cols-2 gap-4 ">
          ...
          <Card className="project-card">
            <div className="img-vignette">
              <img className="project-img" src="/images/algo.png" alt="Sorting Algorithm Visualizer Image" />
            </div>
